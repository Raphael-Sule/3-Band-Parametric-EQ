...
#include "PluginProcessor.h" #include "PluginEditor.h" #include<iostream> #include<list>


//============================================================
==================
EQAudioProcessorEditor::EQAudioProcessorEditor(EQAudioProcesso r& p)
: AudioProcessorEditor(&p), audioProcessor(p), peakFreqAttachment(audioProcessor.apvts, "PeakFreq",
peakFreqSlider), peakGainAttachment(audioProcessor.apvts, "peakGain",
peakGainSlider),
...
// editor's size to whatever you need it to be. addAndMakeVisible(highCutFreqSlider);
 
addAndMakeVisible(lowCutFreqSlider); addAndMakeVisible(peakQualitySlider); addAndMakeVisible(peakGainSlider); addAndMakeVisible(peakFreqSlider); addAndMakeVisible(lowCutSlopeSlider); addAndMakeVisible(highCutSlopeSlider);
...
auto bounds = getLocalBounds(); auto responseArea =
bounds.removeFromTop(bounds.getHeight() * 0.33); auto freqAreaBounds =
...
auto lowCutSlopeArea = lowCutArea; auto lowCutSlopeArea1 =
lowCutSlopeArea.removeFromLeft(lowCutSlopeArea.getWidth() * 0.95);
...
auto lowCutSlopeArea4 = lowCutSlopeArea3.removeFromBottom(lowCutSlopeArea3.getWidth()
* 0.9025);
...
auto highCutFreqArea4 = highCutFreqArea3.removeFromBottom(highCutFreqArea3.getWidth()
* 0.9025);

auto highCutSlopeArea = highCutArea; auto highCutSlopeArea1 =
highCutSlopeArea.removeFromLeft(highCutSlopeArea.getWidth() * 0.95);
 
auto highCutSlopeArea2 = highCutSlopeArea1.removeFromRight(highCutSlopeArea1.getWidth()
* 0.9025);
auto highCutSlopeArea3 = highCutSlopeArea2.removeFromTop(highCutSlopeArea2.getWidth() * 0.95);
auto highCutSlopeArea4 = highCutSlopeArea3.removeFromBottom(highCutSlopeArea3.getWidth(
) * 0.9025);
...
auto peakQualityArea4 = peakQualityArea3.removeFromBottom(peakQualityArea3.getWidth()
* 0.9025);
...
auto peakGainArea = bounds; auto peakGainArea1 =
...
lowCutFreqSlider.setBounds(lowCutFreqArea4); highCutFreqSlider.setBounds(highCutFreqArea4);

lowCutSlopeSlider.setBounds(lowCutSlopeArea4); highCutSlopeSlider.setBounds(highCutSlopeArea4);

peakFreqSlider.setBounds(peakFreqArea4); peakGainSlider.setBounds(peakGainArea4); peakQualitySlider.setBounds(peakQualityArea4); g.fillAll(juce::Colours::black); g.setColour(juce::Colours::white); g.setFont(15.0f);
...
g.setFont(45.0f); g.setColour(juce::Colours::lightblue); g.drawFittedText("3 Band Parametric EQ", responseArea,
...
auto peakGainArea = bounds; auto peakGainArea1 =
peakGainArea.removeFromLeft(peakGainArea.getWidth() * 0.95); auto peakGainArea2 =
peakGainArea1.removeFromRight(peakGainArea1.getWidth() * 0.9025);
auto peakGainArea3 = peakGainArea2.removeFromTop(peakGainArea2.getWidth() * 0.95);
auto peakGainArea4 = (peakGainArea3.removeFromBottom(peakGainArea3.getWidth() * 0.9025));
...
peakFreqSlider.setBounds(peakFreqArea4); peakGainSlider.setBounds(peakGainArea4); peakQualitySlider.setBounds(peakQualityArea4);
